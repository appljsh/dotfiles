...
location_id = "857c942391893cd0ac2ab8e3920f0f4e153562332c26ae7a501474c120e5267f"  # TODO
...
# status code
# status code (más seguro, evita IndexError)
status_class = html_data("#regionHeader").attr("class")

if status_class:
    parts = status_class.split(" ")
